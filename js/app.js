(() => {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        const optionsSlider = document.querySelector(".options__slider");
        ...
        function initSliders() {
            if (window.innerWidth <= 767.98) {
                if (heroSlider && !heroSwiper) heroSwiper = new Swiper(".hero__slider", {
                ...
                if (aboutSlider && !aboutSwiper) heroSwiper = new Swiper(".about__slider", {
                    modules: [ Pagination, Autoplay ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                ...
                if (gallerySlider && !gallerySwiper) heroSwiper = new Swiper(".gallery__slider", {
                    modules: [ Pagination, Autoplay ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                ...
                if (optionsSlider && !optionsSwiper) heroSwiper = new Swiper(".options__slider", {
                    modules: [ Pagination, Autoplay ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                ...
                if (exampleSlider && !exampleSwiper) heroSwiper = new Swiper(".example__slider", {
                    modules: [ Pagination, Autoplay ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                ...
                if (optionsSwiper) {
                    optionsSwiper.destroy();
                    optionsSwiper = null;
                }
                if (exampleSwiper) {
                    exampleSwiper.destroy();
                    exampleSwiper = null;
                }
            }
            ...
            new Swiper(".testinations__slider", {
                modules: [ Pagination, Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                spaceBetween: 42,
                ...
                loop: true,
                pagination: {
                    el: ".testinations__swiper-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".testinations__swiper-button-prev",
                    nextEl: ".testinations__swiper-button-next"
                },
                autoplay: {
                    delay: 1e3,
                    stopOnLastSlide: false,
            ...
            new Swiper(".week__slider", {
                ...
                loop: false,
                navigation: {
                    prevEl: ".week__swiper-button-prev",
                    nextEl: ".week__swiper-button-next"
                },
                breakpoints: {
                    319: {
                        slidesPerView: 1.2,
    ...
    function marquee() {
        ...
        const handleDirectionChange = () => {
            ...
            if (screenWidth < threshold) {
                document.querySelectorAll('[data-marquee-direction="top"]').forEach((el => {
                    el.setAttribute("data-marquee-direction", "left");
                }));
                document.querySelectorAll('[data-marquee-direction="bottom"]').forEach((el => {
                    el.setAttribute("data-marquee-direction", "right");
                }));
            } else {
                document.querySelectorAll('[data-marquee-direction="left"]').forEach((el => {
                    el.setAttribute("data-marquee-direction", "top");
                }));
                document.querySelectorAll('[data-marquee-direction="right"]').forEach((el => {
                    el.setAttribute("data-marquee-direction", "bottom");
                }));
            }
        };
        ...
        $marqueeArray.forEach(($wrapper => {
            ...
            const spaceBetween = !isNaN(dataMarqueeSpace) ? dataMarqueeSpace : 20;
